...
const animation = () => {
	const SELECTORS = {
		wrapperImg: '.js-cat-img-w',
		img: '.js-cat-img',
	};

	const wrapperImg = document.querySelector(SELECTORS.wrapperImg);
	...
	const updatePosition = (e) => {
		...
		const rotationX = ((e.clientY - wrapperCenterY) / (wrapperBounds.height / 2)) * 1; // Поворот по оси X
